...
wall10 = np.c_[np.ones(1320)*(-9.25), np.arange(1320)*0.01 + 0.1]
wall20 = np.c_[np.ones(1320)*(3.0), np.arange(1320)*0.01 + 0.1]
wall30 = np.c_[np.arange(1225)*0.01 - 9.25, np.ones(1225)*(13.3)]
